...
public class Command_Generator {
    ...
    public void displayCommands() {
        ...
        System.out.println("Note you cannot offer a double/set the dice/start a new match right now. Enter 'hint' for a hint or 'pip' to view pip count.");
    }
        ...
        while (!input.matches("^(?!.*(.).*\\1)([a-zA-Z])$") || !bounds) {
            ...
            if (input.matches("^(?!.*(.).*\\1)([a-zA-Z])$")) {
                ...
                if (processCommand(input)) {
                    ...
                    System.out.println("Please enter a valid letter associated with an option. ");
                }
            }
        }
