...
public class Board
{
    ...
    private PrintBoard printBoard; // PrintBoard object to display the board
    ...
    public void Display() {
        printBoard.print(Pips, Orientation, Turn);  // Delegate printing to PrintBoard
    }

    public Vector<Integer> getRolls() {
        return rolls;
    }
